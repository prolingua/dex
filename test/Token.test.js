...
contract('Token', ([deployer, receiver, exchange]) => {
    ...
    beforeEach(async () => {
        token = await Token.new(exchange);
    })
    ...
    describe('sending token from', () => {
        ...
        describe('failure', async () => {
            ...
            it('rejects invalid sender', async() => {
                await token.transfer(0x0, receiver, amount, {from: exchange }).should.be.rejected;
                await token.transfer(receiver, deployer, amount, {from: exchange }).should.be.rejected;
            })
        })
    })
